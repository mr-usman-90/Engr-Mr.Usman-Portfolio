...
const INTENT_PATTERNS: { intent: Intent; patterns: RegExp[] }[] = [
	...
	{ intent: 'cv', patterns: [/\b(cv|resume|resumé|ڈاؤن\s*لوڈ\s*سی\s*وی|سی\s*وی)\b/i] },
	{
		...
		patterns: [
			/\bcertificat\w*\b/i,
			/\bachievement\w*\b/i,
			/\b(digiskills|seo\s*cert|google\s*ai|hp\s*life|opswat|wordpress\s*cert|excel\s*cert|سندی|سرٹیفکیٹ)\b/i
		]
	},
	{
		intent: 'projects',
...
const RESPONSES: Record<Intent, Record<ChatLang, string>> = {
	...
	about: {
		...
		urdu: 'میں Engr.Mr.Usman (عثمان فاروق) ہوں — سافٹ ویئر انجینئر اور فل اسٹیک ڈیولپر، تین سے زائد سال کا تجربہ۔ جدید اور اسکیل ایبل ویب ایپس بناتا ہوں۔ جولائی 2026 سے Prime Softnox Solutions کا بانی اور سی ای او ہوں۔ ملتان، پاکستان۔ پورٹ فولیو: https://usmanfarooq.dev/'
	},
	website: {
	...
	tools: {
		...
		roman:
			"Main GitHub, Docker, AWS, Tailwind, Node.js, Prisma, Zod aur modern frameworks (React, Next.js, SvelteKit) use karta hoon. Cloud Computing aur Networking bhi mere tools mein hain.",
		urdu: 'روزمرہ ٹولز میں GitHub، Docker، AWS، Tailwind، Node.js، Prisma، Zod اور جدید فریم ورکس (React، Next.js، SvelteKit) شامل ہیں۔'
	},
	projects: {
		...
		urdu: 'پروجیکٹس صفحہ پر منتخب پروجیکٹس (12+):\nPrime Softnox، School Management، Blog، Portfolio، Inventory، Social Media، ProEdu LMS، Thumbnail Go، QuickShow، UGC AI، Quickdine، Workflow Planner\nکوڈ: https://github.com/engr-mr-usman'
	},
	certificates: {
		...
		roman:
			"Achievements page pe certificates (11+):\n• SEO — DigiSkills.pk (ID: XQP2YJGMK)\n• Google AI Essentials\n• Technical Support Fundamentals\n• Success Mindset / Business Email / IT for Business Success / Job Interviewing / Ambassador — HP LIFE\n• Critical Infrastructure Protection — OPSWAT\n• WordPress & Microsoft Excel — Coursera\nVerify links Achievements page pe hain.",
		urdu: 'Achievements صفحہ پر 11+ سرٹیفکیٹس ہیں — DigiSkills SEO، Google AI، Technical Support، HP LIFE کورسز، OPSWAT، WordPress، Excel وغیرہ۔'
	},
	contact: {
	...
	cv: {
		...
		roman: `Mera CV yahan se dekh / download kar sakte ho:\n${CV_URL}\nHome page pe Download CV button bhi hai.`,
	...
	freelance: {
		...
		urdu: 'جی ہاں، میں فری لانس کام کے لیے دستیاب ہوں۔ پروجیکٹ کے لیے ای میل یا واٹس ایپ پر رابطہ کریں۔'
	},
	out_of_scope: {
